...
saveRDS(results_0, file = "data_100_3_0.rds")
...
saveRDS(results_05, file = "data_100_3_05.rds")
...
saveRDS(results_1, file = "data_100_3_1.rds")
...
saveRDS(results_15, file = "data_100_3_15.rds")
...
saveRDS(results_2, file = "data_100_3_2.rds")
...
saveRDS(results_25, file = "data_100_3_25.rds")
...
saveRDS(results_3, file = "data_100_3_3.rds")
...
saveRDS(results_35, file = "data_100_3_35.rds")
...
saveRDS(results_4, file = "data_100_3_4.rds")
